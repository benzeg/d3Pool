...
var SetForce = require('./simulation.js').setForce;

var setMouseEvent = function(board, powerGrid, ball) {
	...
	//fetch cueball and gameball nodes to feed into transition
		...
		SetForce(ballSVG, ballNodes, this.forceVec);
